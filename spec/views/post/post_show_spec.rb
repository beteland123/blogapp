...
RSpec.feature 'Post show page', type: :feature do
  let!(:user) { User.create(name: 'Menen', photo: 'men.jpg', postcounter: 3) }
  let!(:post) do
    user.posts.create(
      author: user,
      title: 'Test Post',
  ...
  let!(:comment2) do
    Comment.create(author: lily, post:, text: 'Second post!')
  end
  let!(:comment3) do
    Comment.create(author: lily, post:, text: 'Third post!')
  end
